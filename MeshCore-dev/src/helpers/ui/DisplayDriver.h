...
public:
  ...
  virtual void drawRGBBitmap(int x, int y, const uint16_t* bitmap, int w, int h) { }
  virtual void drawRGBBitmapScaled(int x, int y, const uint16_t* bitmap, int w, int h, float scale) { }
